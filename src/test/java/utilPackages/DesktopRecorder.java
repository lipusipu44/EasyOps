 ...
 */
public class DesktopRecorder extends ScreenRecorder {

	private String name;
	private static DesktopRecorder desktopRecorder;
	Logger log=Logger.getLogger(DesktopRecorder.class);

	public DesktopRecorder(GraphicsConfiguration cfg,
	 ...
	 * This is an over ride method of ScreenshotRecorder of Monte to decide which location the recording file will be saved and 
	 * under which name
	 */
	@Override
	protected File createMovieFile(Format fileFormat) throws IOException {
		if (!movieFolder.exists()) {
			log.info("##### Verifying if the folder exits or not ######");
			movieFolder.mkdirs();
	...
	/**
	 * Method to start desktop recording
	 * @throws Exception
	 */
	...
	{    
		...
		desktopRecorder = new DesktopRecorder(gc, captureSize,
